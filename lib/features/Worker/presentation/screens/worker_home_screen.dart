...
class WorkerHomeScreen extends StatelessWidget {
    ...
    return Consumer<WorkerManagerProvider>(
      builder: (context, workerManager, _) {
        return Scaffold(
          ...
          body: workerManager.isLoading || workerManager.isOrdersLoading
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildWelcomeSection(context, workerManager),
  ...
  Widget _buildWelcomeSection(
    ...
    return Column(
      ...
      children: [
        Text(
          '${AppLocalizations.of(context)!.hello}, ${workerManager.workerInfo?.fullName ?? 'Worker'}!',
